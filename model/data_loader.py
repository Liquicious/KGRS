...
def load_rating(args):
    ...
    # reading rating file
    rating_file = 'C:/Users/korol/PycharmProjects/KGRS-j/sets/' + args.dataset + '/ratings_final'
    if os.path.exists(rating_file + '.npy'):
        rating_np = np.load(rating_file + '.npy')
    else:
        rating_np = np.loadtxt(rating_file + '.txt', dtype=np.int64, delimiter='\t')
...
def load_kg(args):
    ...
    # reading kg file
    kg_file = 'C:/Users/korol/PycharmProjects/KGRS-j/sets/' + args.dataset + '/kg_final'
